    ...
    <div className='home-body-container'>
        <div className='home-content'>
            ...
            <div className='home-links'>
                <div className='link-div' onClick={() => props.history.push('/search/San Francisco')}>
                ...
                <div className='link-div' onClick={() => props.history.push('/search/New York')}>
                    <img className='quick-link'
                ...
                <div className='link-div' onClick={() => props.history.push('/search/Honolulu')}>
                    <img className='quick-link'
